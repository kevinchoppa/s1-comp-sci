...
//     System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y",27));
    ...
    //     }
        ...
        // while(a<37)
        // {
        //     System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y",a));
        //     a++;
        // }


    System.out.println(Cipher.encode("1 y1z5 v2q9w1"));
        
    System.out.println("give me a message");
    System.out.println("here: ");
    String answer = sc.nextLine();
    System.out.println(Cipher.encode(answer));
